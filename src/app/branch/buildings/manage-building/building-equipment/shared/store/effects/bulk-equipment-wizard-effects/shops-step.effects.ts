...
export class ShopsStepEffects {
  ...
  // Unit change
  @Effect() unitChange = this.actions$.pipe(
  ...
  @Effect() serialNumberChange = this.actions$.pipe(
  ...
  // order change
  @Effect() orderChange = this.actions$.pipe(
  ...
  // Parent change
  @Effect() parentChange = this.actions$.pipe(
